...
// usuarios.map((item)=> console.log(item.correo))

// Sumar las edades de todos los usuarios.
// const initialValue = 0;
// const suma = usuarios.reduce(
//     (accumulator,item) => accumulator + item.edad,
//     initialValue,
// )
// console.log(suma);

// Encontrar el usuario con mayor edad.
const usuarioMayor = usuarios.reduce((mayor, usuario) => {
    return (usuario.edad > mayor.edad) ? usuario : mayor;
}, usuarios[0]);
  
// console.log("El usuario con mayor edad es:", usuarioMayor);

// Verificar si algún usuario tiene menos de 25 años.
// const menor = usuarios.find((item) => item.edad < 25);
// console.log(menor);
